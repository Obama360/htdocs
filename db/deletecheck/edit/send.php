...
if (isset($_POST["sendA"]) && $_POST["sendA"] == "editdelete")  {
  unset($_POST["sendA"]);
} else {
...
<html lang="de" dir="ltr">
  ...
  <body>
    ...
    if (isset($_SESSION["uid"]) && $_SESSION["uid"] != "") {
      ...
      $sqlset = "UPDATE deletecheck SET checkADDelete = '" . $_POST["ADDelete"] . "', finishdate = '" . $finishdate . "', checkNotesDelete = '" . $_POST["NotesDelete"] . "', checkTelDelete = '" . $_POST["TelDelete"] . "', checkIQSDelete = '" . $_POST["IQSDelete"] . "', checkWADelete = '" . $_POST["WADelete"] . "', checkHWSWDelete = '" . $_POST["HWSWDelete"] . "', comment = '" . $_POST["comment"] . "' WHERE idDelete = '" . $_SESSION["uid"] . "'";
    } else {
      echo "<p>Der Eintrag wurde bereits bearbeitet.</p>";
      echo "<a href='/db/deletecheck/edit/index.php'>Andere Checkliste auswählen</a>";
      ...
      die("Es konnte keine Verbindung mit dem Datenbankserver aufgebaut werden!");
          ...
          if ($conn->query($sqlset) === TRUE) {
            ...
            if (isset($_POST["submit"]) && $_POST["submit"] == "Änderungen übernehmen und zurück zum Menu") {
              ...
              echo "<script> location.href='/db/deletecheck/edit/view.php?id=". $uid . "'; </script>";
            }
