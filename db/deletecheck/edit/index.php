...
<html lang="de" dir="ltr">
  <head>
    <meta charset="utf-8">
    <title>User löschen Checkliste öffnen</title>
  ...
  <body>
    ...
    $username = "userlister";
    $db = "userlist";
    $sql = "SELECT u.name, u.surname, u.shorty, u.number, u.workstart, u.telintern, u.telmobile, c.IdDelete FROM deletecheck AS c LEFT JOIN createuser AS u ON c.fkIdUser = u.idUser WHERE " . $sqlfilter . " ORDER BY u.idUser DESC";
    ...
    <div class="tablecontainer">
      <table id="userlist">
        ...
        <?php while($entry = mysqli_fetch_array($userlist)):; ?>
          <tr onclick="window.location='/db/deletecheck/edit/view.php?id=<?php echo $entry[7] ?>';">
