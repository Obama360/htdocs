...
<html lang="de" dir="ltr">
  ...
  <body>
    ...
    <a class="button" href="/db/index.php">Zurück zu Menu</a> <hr>

    <?php
    $servername = "localhost";
    $username = "userlister";
    $db = "userlist";
    $sql = "SELECT u.name, u.surname, u.shorty, u.number, u.workstart, u.telintern, u.telmobile, u.IdUser FROM createuser AS u LEFT JOIN deletecheck as c on u.idUser = c.fkIdUser WHERE NULLIF(c.fkIdUser, '') IS NULL ORDER BY u.idUser DESC";
    ...
    <div class="tablecontainer">
      <table id="userlist">
        ...
        <?php while($entry = mysqli_fetch_array($userlist)):; ?>
          <tr onclick="window.location='/db/deletecheck/create/select.php?id=<?php echo $entry[7] ?>';">
