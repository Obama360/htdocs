...
<html lang="de" dir="ltr">
  ...
  <body>
    ...
    if (!isset($_SESSION["uid"]) || $_SESSION["uid"] == "") {
      ...
      die("<a class='button' href='/db/addcheck/index.php'>User auswählen</a>");
    }
    $sqlover = "SELECT COUNT(idCreate) FROM createcheck WHERE fkIdUser = '" . $_SESSION["uid"] . "'";
    ...
    <div class="invisiblecontainer">
      ...
      <br>
      <a class="button" href="/db/addcheck/create/index.php">Anderen User auswählen</a>
    ...
    if ($over[0] > 0) {
      ...
      $_SESSION["sendA"] = "createcreate";
      echo "<a class='button' href='/db/addcheck/create/send.php'>Checkliste anlegen</a>";
    }
    ?>
    </div>
  </body>
